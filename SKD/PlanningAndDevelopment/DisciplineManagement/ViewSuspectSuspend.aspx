<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="ViewSuspectSuspend.aspx.cs" Inherits="WebUI_New_ViewSuspectSuspend" %>
...
<table cellpadding="1" cellspacing="1" style="width:100%;">
        ...
        <tr>
            <td>
                <Asp:GridView ID="uiDgSuspectSuspend" runat="server" 
                    AutoGenerateColumns="False" Width="100%" 
                    MouseHoverRowHighlightEnabled="True" 
                    RowHighlightColor="" onrowcommand="uiDgSuspectSuspend_RowCommand">
