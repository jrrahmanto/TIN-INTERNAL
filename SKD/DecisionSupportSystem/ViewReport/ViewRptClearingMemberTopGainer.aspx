<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="ViewRptClearingMemberTopGainer.aspx.cs" Inherits="DecisionSupportSystem_ViewReport_ViewRptClearingMemberTopGainer" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
   <h1>View Report Clearing Member Top Gainer</h1>
                ...
                <table class="table-row">
                    ...
                    <tr>
                        ...
                        <td>
                            :</td>
                        <td>
                            <asp:DropDownList ID="uiDdlCMType" runat="server" Width="130px">
