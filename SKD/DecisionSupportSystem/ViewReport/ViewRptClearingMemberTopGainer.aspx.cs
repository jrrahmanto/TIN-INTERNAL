...
public partial class DecisionSupportSystem_ViewReport_ViewRptClearingMemberTopGainer : System.Web.UI.Page
{
    ...
    private void GetReport()
    {
        ...
        uiRptViewer.ServerReport.ReportPath = "/SKDReport/RptClearingMemberTopGainer";
        ...
        if (string.IsNullOrEmpty(uiDdlCMType.SelectedValue))
        {
            rp.Add(new ReportParameter("cmType", new string[] { null }));
        }
        else
        {
            rp.Add(new ReportParameter("cmType", new string[] { uiDdlCMType.SelectedValue }));
        }
        if (string.IsNullOrEmpty(uiTxtTopSelect.Text))
        {
