<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="DetailInbox.aspx.cs" Inherits="DetailInbox" %>
                ...
                <table class="table-row">
                    ...
                    <tr>
                        ...
                        <td valign="top">
                            :</td>
                        <td >
                            <asp:TextBox ID="uiTxbMessage" runat="server" Height="110px" 
                                TextMode="MultiLine" Width="383px" BorderStyle="None"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td >
