<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="ViewRptNotaRequestTender.aspx.cs" Inherits="ClearingAndSettlement_ViewClearingMember_ViewRptNotaRequestTender" %>
...
<h1>View Report Nota Request Tender</h1>
                ...
                <table class="table-row">
                    ...
                    <tr>
                        ...
                        <td>
                            :</td>
                        <td>
                            <asp:TextBox ID="uiTxtDeliveryOrder" runat="server"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td>
