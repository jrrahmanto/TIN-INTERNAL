...
public partial class ClearingAndSettlement_ViewClearingMember_ViewRptBuyerTenderAnnouncement : System.Web.UI.Page
{
    ...
    protected void uiBtnSearch_Click(object sender, EventArgs e)
    {
        try
        {
            if (IsValidGet() == true)
            {
                ApplicationLog.Insert(DateTime.Now, "Report Buyer Tender Announcement", "I", "Download", Page.User.Identity.Name, Common.GetIPAddress(this.Request));
                GetReport();
            }
        }
        catch (Exception ex)
    ...
    private void GetReport()
    {
        ...
        uiRptViewer.ServerReport.ReportPath = "/SKDReport/RptBuyerTenderAnnouncement";
