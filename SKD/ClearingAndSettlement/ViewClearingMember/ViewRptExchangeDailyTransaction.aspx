<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="ViewRptExchangeDailyTransaction.aspx.cs" Inherits="ClearingAndSettlement_ViewClearingMember_ViewRptExchangeDailyTransaction"  %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <h1>View Report Exchange Daily Transaction</h1>
                ...
                <table class="table-row">
                    ...
                    <tr>
                        ...
                        <td>
                            :</td>
                        <td>
                            <uc2:CtlExchangeLookup ID="CtlExchangeLookup1" runat="server" />
                        </td>
                    </tr>
                    <tr>
                        <td>
