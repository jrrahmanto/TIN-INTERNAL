...
public partial class ClearingAndSettlement_ViewClearingMember_ViewRptBapebtiTenderAnnouncement : System.Web.UI.Page
{
    ...
    protected void uiBtnSearch_Click(object sender, EventArgs e)
    {
        try
        {
            if (IsValidGet() == true)
            {
                ApplicationLog.Insert(DateTime.Now, "Report Bapebti Tender Annoucement", "I", "Download", Page.User.Identity.Name, Common.GetIPAddress(this.Request));
                GetReport();
            }
        }
        catch (Exception ex)
    ...
    private void GetReport()
    {
        ...
        uiRptViewer.ServerReport.ReportPath = "/SKDReport/RptBapebtiTenderAnnouncement";
