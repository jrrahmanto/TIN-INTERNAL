<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="ViewRptClearingMemberTransactionByQueryDcml.aspx.cs" Inherits="ClearingAndSettlement_ReportEOD_ViewClearingMember_ViewClearingMemberTransactionByQueryDcml"  %>
...
<%@ Register src="../../Lookup/CTLMultiCLearingMemberLookup.ascx" tagname="CTLMultiCLearingMemberLookup" tagprefix="uc8" %>


<%@ Register src="../../Lookup/CtlContractCommodityLookup.ascx" tagname="CtlContractCommodityLookup" tagprefix="uc9" %>


<%@ Register src="../../Lookup/CtlCommodityLookup.ascx" tagname="CtlCommodityLookup" tagprefix="uc10" %>


<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <h1>View Report Clearing Member Decimal Transaction Query</h1>
                ...
                <table class="table-row">
                    ...
                    <tr>
                        ...
                        <td style="width:10px">
                            :</td>
                        <td>
                            <uc8:CTLMultiCLearingMemberLookup ID="CTLMultiCLearingMemberLookup1" 
                                runat="server" />
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td>
                            :</td>
                        <td>
                            <uc10:CtlCommodityLookup ID="CtlCommodityLookup1" runat="server" />
                        </td>
                    </tr>
                    <tr>
                        <td>
