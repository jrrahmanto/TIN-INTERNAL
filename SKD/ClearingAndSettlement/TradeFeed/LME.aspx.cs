...
public partial class ClearingAndSettlement_TradeFeed_LME : System.Web.UI.Page
{
    ...
    protected void uiBtnSearch_Click(object sender, EventArgs e)
    {
        ...
        {
            GetReport();
            ApplicationLog.Insert(DateTime.Now, "Report LME", "I", "View", Page.User.Identity.Name, Common.GetIPAddress(this.Request));
        }
        catch (Exception ex)
        {
            uiBLError.Visible = true;
    ...
    private void GetReport()
    {
        ...
        uiRptViewer.ServerReport.ReportPath = "/TIN_EOD_Report/RptLME";
