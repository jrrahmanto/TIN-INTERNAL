<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="NoticeOfShipment.aspx.cs" Inherits="ClearingAndSettlement_TradeFeed_NoticeOfShipment" %>
                            ...
                            <div class="shadow_view">
                                <div class="box_view">
                                    <table class="table-row">                
                                        ...
                                        <tr>
                                            <td>No Shipping Instruction</td>
                                            <td>:</td>
                                            <td><asp:TextBox runat="server" id="NoSI" /></td>
                                        </tr>
                                        <tr>
                                            <td>Exchange Ref</td>
                                            <td>:</td>
                                            <td><asp:TextBox runat="server" id="ExchangeRef" /></td>
                                        </tr>
                                        <tr>
                                            <td>&nbsp;</td>
                                            <td>&nbsp;</td>
                                            <td>
                                                <asp:Button ID="uiBtnDownload" runat="server" Text="     Invoice" CssClass="button_search" onclick="uiBtnDownload_Click" />&nbsp;
                                                <asp:Button ID="uiBtnSearch" runat="server" Text="     Search" CssClass="button_search" onclick="uiBtnSearch_Click" />&nbsp;
                                                <asp:Button ID="uiBtnGenerate" runat="server" Text="      Generate All" CssClass="button_search" onclick="uiBtnGenerateAll_Click" />&nbsp;
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>&nbsp;</td>
                                    ...
                                    <ContentTemplate>
                                        <asp:GridView ID="uiDgTradeFeed" runat="server" AutoGenerateColumns="False" 
                                            ...
                                            <Columns>
                                                <asp:TemplateField HeaderText="Detail">
                                                    <ItemTemplate>
                                                        <asp:LinkButton id="test" runat="server" onClick="uiBtnGenerate_Click" CommandArgument='<%# DataBinder.Eval(Container.DataItem, "NoSI") %>' Text="Print"/>
                                                    </ItemTemplate>
                                                    <ItemStyle HorizontalAlign="Center" Width="60px" />
                                                </asp:TemplateField>
                                                <asp:BoundField DataField="ExchangeId" HeaderText="ExchangeId" 
                                                ...
                                                <asp:BoundField DataField="ApprovalStatus" HeaderText="ApprovalStatus" 
                                                    Visible="False" />
                                                <asp:BoundField DataField="NoSI" HeaderText="NoSI" 
                                                    Visible="True">
                                                    <ItemStyle HorizontalAlign="Center" />
                                                </asp:BoundField>
                                                <asp:BoundField DataField="SellerRef" HeaderText="SellerRef" 
                                                    Visible="True">
                                                    <ItemStyle HorizontalAlign="Center" />
                                                </asp:BoundField>
                                                <asp:BoundField DataField="TradeFeedID" HeaderText="TradeFeedID" 
                                                ...
                                                <asp:BoundField DataField="ContractYearMonth" HeaderText="Contract Month" 
                                                    SortExpression="ContractYearMonth" ItemStyle-HorizontalAlign="Center"  visible="false"/>
                                                <asp:TemplateField HeaderText="Price" SortExpression="Price">
                                                    <ItemTemplate>
