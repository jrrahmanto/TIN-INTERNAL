<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="ViewTradeFeedExceptionAutoApprv.aspx.cs" Inherits="ClearingAndSettlement_TradeFeed_ViewTradeFeedExceptionAutoApprv" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <h1>View Trade Register Exception With Multi-Trade-Approval</h1>
    <asp:Panel ID="pnlException" runat="server">
        ...
        <tr><td>
            <asp:Button ID="btnApproveAll" runat="server" OnClick="btnApproveAll_Click" 
                    Text="Approve All" CssClass="button_approve" Width="130px" />&nbsp;
            <asp:Label ID="uiLblApprovalDesc" runat="server">Approval Desc:</asp:Label>&nbsp;
            <asp:TextBox ID="uiTxtApprovalDesc" runat="server"></asp:TextBox>
                </td></tr>
        <tr>
        <td>
