<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="ViewTradeFeed.aspx.cs" Inherits="ClearingAndSettlement_TradeFeed_ViewTradeFeed" %>
            ...
            <div class="box_view">
                ...
                <tr>
                    <td style="width:100px">
                        <asp:Button ID="uiBtnImport0" runat="server" CssClass="button_import" 
                            onclick="uiBtnImport_Click" Text="     Import" />
                    </td>
                </tr>
                <tr>
                    <td style="width:10px">
