<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="ApprovalSI.aspx.cs" Inherits="ClearingAndSettlement_TradeFeed_ApprovalSI" %>
        ...
        <tr>
            ...
            <table class="table-row">
                ...
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="noSi" OnClientClick="this.disabled = true;" runat="server" Disable ="True"></asp:TextBox>
                ...
                <tr>
                    <td>
                        Shipping Instruction File
                    </td>
                    <td >
                        :</td>
                    <td>
                        <asp:Button ID="uiBtnShippingInstr" runat="server" OnClick="uiBtnShippingInstr_Click" Text="Download" />&nbsp;
                        <asp:Label ID="uiLblShippingInstr" runat="server"/>
                    </td>
                </tr>
                <tr>
                    <td>
