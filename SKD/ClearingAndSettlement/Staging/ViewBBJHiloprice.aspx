<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="ViewBBJHiloprice.aspx.cs" Inherits="ClearingAndSettlement_Staging_ViewBBJHiloprice" %>
        ...
        <tr>
            <td>
                <cc1:ProgressUpdatePanel ID="UpdatePanel1" runat="server">
                    <ContentTemplate>
                        <asp:GridView ID="uiDgHiloprice" runat="server" AutoGenerateColumns="False" Width="100%"
                            MouseHoverRowHighlightEnabled="True" RowHighlightColor="" DataKeyNames="Id"
                            AllowPaging="True" AllowSorting="True" OnPageIndexChanging="uiDgHiloprice_PageIndexChanging"
                            OnSorting="uiDgHiloprice_Sorting">
                        ...
                        <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" SelectMethod="SelectHiloprice" TypeName="StagingHiloprice" OldValuesParameterFormatString="original_{0}">
                            <SelectParameters>
