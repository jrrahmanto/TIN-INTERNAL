...
public partial class ClearingAndSettlement_MasterData_ImportIrcaAutoApprv : System.Web.UI.Page
{
    ...
    protected void uiBtnUpload_Click(object sender, EventArgs e)
    {
        if (IsValidUpload())
        {
            try
            {
                ...
                ImportIrca imp = new ImportIrca(typeof(ClsImportIrca),
                                        User.Identity.Name, uiTxtApprovalDesc.Text);
