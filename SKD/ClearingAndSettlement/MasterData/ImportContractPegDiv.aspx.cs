...
public partial class ClearingAndSettlement_MasterData_ImportContractPegDiv : System.Web.UI.Page
{
    ...
    protected void uiBtnUpload_Click(object sender, EventArgs e)
    {
        if (IsValidUpload())
        {
            try
            {
                ...
                ImportContractPegDiv imp = new ImportContractPegDiv(typeof(ClsImportContractPegDiv),
    ...
    protected void uiBtnCancel_Click(object sender, EventArgs e)
    {
        if (Menu == "hide")
        {
            Response.Redirect("ViewContract.aspx?menu=hide");
        }
        else
        {
