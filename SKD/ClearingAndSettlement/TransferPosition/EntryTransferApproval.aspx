<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="EntryTransferApproval.aspx.cs" Inherits="ClearingAndSettlement_TransferPosition_EntryTransferApproval" %>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:ObjectDataSource ID="ObjectDataSourceTransferPosition" 
                                ...
                                TypeName="Transfer">
                                <SelectParameters>
                                    <asp:QueryStringParameter Name="transferId" QueryStringField="eID" 
                                        Type="Decimal" />
                                </SelectParameters>
        ...
        <tr>
            <td id="tdImage" runat="server">
                <asp:GridView ID="uiDgTransferRequest" runat="server" 
                    ...
                    DataKeyNames="InvestorID,ContractID,TradePosition,Position,TransferID,Price" 
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="TransferID" HeaderText="Transfer ID" ReadOnly="True" 
                            SortExpression="TransferID" Visible="False" />
                ...
                <asp:ObjectDataSource ID="ObjectDataSourceTransferRequest" runat="server" 
                    SelectMethod="GetTransferRequestByTransferID" TypeName="Transfer">
                    <SelectParameters>
                        <asp:QueryStringParameter Name="transferId" QueryStringField="eID" 
                            Type="Decimal" />
                    </SelectParameters>
