<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="ViewTransferApproval.aspx.cs" Inherits="WebUI_New_ViewTransferApproval" %>
                        ...
                        <ContentTemplate>
                            <asp:GridView ID="uiDgTransferPosition" runat="server" AutoGenerateColumns="False"
                                ...
                                <Columns>
                                    <asp:TemplateField>
                                        <ItemTemplate>
                                            <a href="EntryTransferApproval.aspx?menu=<%# Request.QueryString["menu"] %>&eType=edit&eID=<%# DataBinder.Eval(Container.DataItem, "TransferID")  %>">
                                                Edit </a>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                            ...
                            <asp:ObjectDataSource ID="ObjectDataSourceTransferPosition" runat="server" SelectMethod="GetTransferPositionByTransferDateDestCMTypeApproval"
