<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="ViewRptSummaryActivityClearingMemberPeriod.aspx.cs" Inherits="FinanceAndAccounting_ViewReport_ViewRptSummaryActivityClearingMemberPeriod" %>
...
<h1>View Report Summary Activity Clearing Member Period</h1>
                ...
                <table class="table-row">
                    ...
                    <tr>
                        ...
                        <td>
                            :</td>
                        <td>
                            <uc1:CtlCalendarPickUp ID="CtlCalendarPickUpEndDate" runat="server" />
                        </td>
                    </tr>
                    <tr>
                        <td>
