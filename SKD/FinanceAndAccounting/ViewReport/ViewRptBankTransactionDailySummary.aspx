<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="ViewRptBankTransactionDailySummary.aspx.cs" Inherits="FinanceAndAccounting_ViewReport_ViewRptBankTransactionDailySummary" %>
...
<h1>View Report Bank Transaction Daily Summary</h1>
                ...
                <table class="table-row">
                    ...
                    <tr>
                        ...
                        <td>
                            :</td>
                        <td>
                            <uc1:CtlCalendarPickUp ID="CtlCalendarPickUpBusinessDate" runat="server" />
                        </td>
                    </tr>
                    <tr>
                        <td>
