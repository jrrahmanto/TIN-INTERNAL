<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="ViewManagePostingCode.aspx.cs" Inherits="WebUI_FinanceAndAccounting_ViewManagePostingCode" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <h1>View Manage Posting Code</h1>
            ...
            <tr>
                <td>
                    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                        <ContentTemplate>
                            <asp:GridView ID="uiDgPostingCode" runat="server" AutoGenerateColumns="False" Width="100%"
                                MouseHoverRowHighlightEnabled="True" RowHighlightColor="" AllowPaging="True"
                                AllowSorting="True" DataKeyNames="AccountCode,LedgerType,ApprovalStatus" OnPageIndexChanging="uiDgPostingCode_PageIndexChanging"
                                OnSorting="uiDgPostingCode_Sorting" PageSize="15">
                                <RowStyle CssClass="tblRowStyle" />
                                <Columns>
                                    <asp:TemplateField HeaderText="Edit">
                                        <ItemTemplate>
                                            <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl='<%# Eval("AccountID", "~/FinanceAndAccounting/EntryManagePostingCode.aspx?eType=edit&eID={0}") %>'
                            ...
                            <asp:ObjectDataSource ID="ObjectDataSourcePostingCode" runat="server" SelectMethod="GetPostingCodeByAccountCodeAndApprovalStatus"
                                TypeName="Posting">
                                <SelectParameters>
