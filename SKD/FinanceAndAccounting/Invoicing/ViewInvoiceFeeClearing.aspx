<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="ViewInvoiceFeeClearing.aspx.cs" Inherits="FinanceAndAccounting_Invoicing_ViewInvoiceFeeClearing" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <h1>View Invoice Fee Clearing</h1>
                ...
                <td>
                    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                        <ContentTemplate>
                            ...
                            <asp:ObjectDataSource ID="ObjectDataSourceInvoice" runat="server" SelectMethod="SelectInvoiceByFilterFC"
