...
public partial class FinanceAndAccounting_Invoicing_ViewInvoiceAnnualMembership : System.Web.UI.Page
{
    ...
    {
        Response.Redirect("EntryInvoiceAnnualMembership.aspx?eType=add");
    }
    ...
    private void SetAccessPage()
    {
        try
        {
            ...
            uiDgInvoice.Columns[0].Visible = mp.IsMaker || mp.IsChecker;
        }
        catch (Exception ex)
        {
            throw new ApplicationException(ex.Message, ex);
