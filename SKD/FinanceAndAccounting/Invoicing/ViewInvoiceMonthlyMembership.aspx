<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="ViewInvoiceMonthlyMembership.aspx.cs" Inherits="FinanceAndAccounting_Invoicing_ViewInvoice" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <h1>View Invoice Monthly Membership</h1>
                ...
                <td>
                    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                        <ContentTemplate>
                            ...
                            <asp:ObjectDataSource ID="ObjectDataSourceInvoice" runat="server" SelectMethod="SelectInvoiceByFilterMM"
