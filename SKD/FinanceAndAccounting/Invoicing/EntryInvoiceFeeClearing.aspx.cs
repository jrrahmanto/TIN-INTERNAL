...
public partial class FinanceAndAccounting_Invoicing_EntryInvoiceFeeClearing : System.Web.UI.Page
{
    ...
    protected void uiBtnSave_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            {
                string pathInvoice = string.Format("{0}\\{3}\\{1}_{2}_Invoice.pdf", System.Configuration.ConfigurationManager.AppSettings[Common.SETTING_FOLDER_INVOICE_FEE].ToString(), DateTime.Parse(CtlCalendarPickUp2.Text).ToString("yyyyMMdd"), CtlClearingMemberLookup1.LookupTextBox, CtlClearingMemberLookup1.LookupTextBox);
                string pathFakturPajak = string.Format("{0}\\{3}\\{1}_{2}_FakturPajak.pdf", System.Configuration.ConfigurationManager.AppSettings[Common.SETTING_FOLDER_INVOICE_FEE].ToString(), DateTime.Parse(CtlCalendarPickUp2.Text).ToString("yyyyMMdd"), CtlClearingMemberLookup1.LookupTextBox, CtlClearingMemberLookup1.LookupTextBox);

                if (!Directory.Exists(string.Format("{0}\\{1}\\", System.Configuration.ConfigurationManager.AppSettings[Common.SETTING_FOLDER_INVOICE_FEE].ToString(), CtlClearingMemberLookup1.LookupTextBox)))
                {
                    Directory.CreateDirectory(string.Format("{0}\\{1}\\", System.Configuration.ConfigurationManager.AppSettings[Common.SETTING_FOLDER_INVOICE_FEE].ToString(), CtlClearingMemberLookup1.LookupTextBox));
                }
                ...
                inta.Insert(
                    decimal.Parse(CtlClearingMemberLookup1.LookupTextBoxID), "", "FC", DateTime.Parse(CtlCalendarPickUp2.Text), 0, 0,
                ...
                Response.Redirect("ViewInvoiceFeeClearing.aspx");
            }
        }
        catch (Exception ex)
        {
