<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="ViewBankPDM.aspx.cs" Inherits="WebUI_New_ViewBankPDM" %>
                        ...
                        <div class="box_view">
                            <table class="table-row">
                                <tr>
                                    ...
                                    <td>
                                        <asp:TextBox ID="uiTxtBankCode" runat="server"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
            ...
            <tr>
                <td>
                    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                        <ContentTemplate>
                            <asp:GridView ID="uiDgBankPDM" runat="server" AutoGenerateColumns="False" Width="100%"
                                MouseHoverRowHighlightEnabled="True" RowHighlightColor="" AllowPaging="True"
                                AllowSorting="True" OnPageIndexChanging="uiDgBankPDM_PageIndexChanging" OnSorting="uiDgBankPDM_Sorting">
                                <RowStyle CssClass="tblRowStyle" />
                                <Columns>
                                    <asp:TemplateField HeaderText="Edit">
                                        <ItemTemplate>
                                            <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl='<%# Eval("BankID", "~/FinanceAndAccounting/Parameter/EntryBankPDM.aspx?eType=edit&eID={0}") %>'
                                                Text="Edit" ImageUrl="~/Images/edit.gif"></asp:HyperLink>
                                        </ItemTemplate>
                                        <ItemStyle HorizontalAlign="Center" Width="60px" />
                                    </asp:TemplateField>
                                    <asp:BoundField DataField="Code" HeaderText="Bank Code" SortExpression="Code" >
                                    </asp:BoundField>
                            ...
                            <asp:ObjectDataSource ID="ObjectDataSourceBankPDM" runat="server" SelectMethod="SelectBankByCodeAndStatus"
                                TypeName="BankPDM">
                                <SelectParameters>
                                    <asp:ControlParameter ControlID="uiTxtBankCode" Name="bankCode" PropertyName="Text"
                                        Type="String" />
