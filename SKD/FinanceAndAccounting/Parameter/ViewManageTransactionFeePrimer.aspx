<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="ViewManageTransactionFeePrimer.aspx.cs" Inherits="FinanceAndAccounting_Parameter_ViewManageTransactionFeePrimer" Title="Untitled Page" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <h1>View Manage Transaction Fee Primer</h1>
            ...
            <tr>
                <td>
                    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                        <ContentTemplate>
                            <asp:GridView ID="uiDgTransactionFeePrimer" runat="server" AutoGenerateColumns="False"
                                ...
                                OnPageIndexChanging="uiDgTransactionFeePrimer_PageIndexChanging" OnSorting="uiDgTransactionFeePrimer_Sorting">
                                <RowStyle CssClass="tblRowStyle" />
                                <Columns>
                                    <asp:TemplateField HeaderText="Edit">
                                        <ItemTemplate>
                                            <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl='<%# Eval("TransactionFeePrimerID", "~/FinanceAndAccounting/Parameter/EntryManageTransactionFeePrimer.aspx?eType=edit&eID={0}") %>'
                                    ...
                                    <asp:BoundField DataField="EffectiveStartDate" 
                                     ...
                                     <asp:BoundField DataField="upperlimit" HeaderText="Upper Limit" SortExpression="upperlimit" DataFormatString="{0:#,###}">
                            ...
                            <asp:ObjectDataSource ID="ObjectDataSourceTransactionFeePrimer" runat="server" SelectMethod="SelectTransactionFeePrimerByCommodityCodeCmTypeAndStatus"
