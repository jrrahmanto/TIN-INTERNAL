<%@ Control Language="C#" AutoEventWireup="true" CodeFile="CtlClearingMemberInvoiceLookup.ascx.cs" Inherits="Lookup_CtlClearingMemberInvoiceLookup" %>
                ...
                <tr>                    
                    <td valign="top">
                        ...
                        <asp:ObjectDataSource ID="ObjectDataSourceClearingMember" runat="server" 
                            SelectMethod="GetClearingMemberInvoiceByCodeAndName" TypeName="ClearingMember" 
