<%@ Control Language="C#" AutoEventWireup="true" CodeFile="CtlContractCommodityStressTestLookup.ascx.cs" Inherits="Lookup_CtlContractCommodityStressTestLookup" %>
                ...
                <tr>                    
                    <td valign="top">
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Contract ID" SortExpression="ContractID" 
                                    ...
                                    <ItemTemplate>
                                        ...
                                        <asp:Label ID="uiLblLow" runat="server" Text='<%# Bind("Low","{0:#,##0.##########}") %>'></asp:Label>
                                        <asp:Label ID="uiLblHigh" runat="server" Text='<%# Bind("High","{0:#,##0.##########}") %>'></asp:Label>
                                    </ItemTemplate>
                                    <EditItemTemplate>
                        ...
                        <asp:ObjectDataSource ID="ObjectDataSourceContract" runat="server" 
                            SelectMethod="GetContractStressTestByCommodityCode" TypeName="Contract" 
                            ...
                            <SelectParameters>
                                ...
                                <asp:Parameter Name="businessDate" Type="DateTime" />
                            </SelectParameters>
