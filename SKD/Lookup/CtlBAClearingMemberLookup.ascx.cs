...
public partial class Lookup_CtlBAClearingMemberLookup : System.Web.UI.UserControl
{
    ...
    private string _investorLookupID;
    public string InvestorCodeLookupID
    {
        get
        {
            return _investorLookupID;
        }
        set
        {
            _investorLookupID = value;
        }
    }
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (InvestorCodeLookupID != null)
        {
            script += string.Format("window.document.forms[0].{0}.value =''; " ,
                        InvestorCodeLookupID);
        }
        ...
        if (btn != null)
        {
            ...
            if (InvestorCodeLookupID != null)
            {
                ...
                script = string.Format("window.document.forms[0].{0}.value = '{1}'; " +
                            ...
                            InvestorCodeLookupID, e.Row.Cells[2].Text,
                            uiBtnLookup_ModalPopupExtenderClearingMember.ClientID);
