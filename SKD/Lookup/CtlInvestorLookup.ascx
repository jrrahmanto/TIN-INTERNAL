<%@ Control Language="C#" AutoEventWireup="true" CodeFile="CtlInvestorLookup.ascx.cs" Inherits="Lookup_CtlInvestorLookup" %>
                ...
                <tr>                    
                    <td valign=top>
                        ...
                        <asp:ObjectDataSource ID="ObjectDataSourceInvestor" runat="server" 
                            SelectMethod="GetInvestorByCodeNameApprovalStatus" TypeName="Investor" 
                            OldValuesParameterFormatString="original_{0}">
                            <SelectParameters>
                                <asp:ControlParameter ControlID="uiTxtInvestorCode" Name="code" PropertyName="Text" 
                                    Type="String" />
                                <asp:ControlParameter ControlID="uiTxtInvestorCode" Name="name" 
