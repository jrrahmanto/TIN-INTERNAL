...
public partial class Lookup_CtlBankAccountSuretyBondLookup : System.Web.UI.UserControl
{
    ...
    protected void uiDgBankAccount_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            if (btn != null)
            {
                ...
                btn.Attributes.Add("onclick", "window.document.forms[0]." + uiTxtLookupBankAccount.ClientID + ".value = '" + e.Row.Cells[2].Text + '-' + e.Row.Cells[3].Text + '-' + e.Row.Cells[4].Text + '-' + e.Row.Cells[5].Text +
                    "';window.document.forms[0]." + uiTxtLookupIDBankAccount.ClientID + ".value = '" + lblBankAccount.Text + "';return HideModalPopupBankAccount" + uiBtnLookup_ModalPopupExtenderBankAccount.ClientID + "();");
