<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="ViewRptSettlementPriceMovement.aspx.cs" Inherits="BusinessInteligence_ViewReport_ViewRptSettlementPriceMovement" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
 <h1>View Report Settlement Price Movement</h1>
                ...
                <table class="table-row">
                    ...
                    <tr>
                        ...
                        <td>
                            :</td>
                        <td>
                            <uc4:CtlCalendarPickUp ID="CtlCalendarPickUpBusinessDateFrom" runat="server" />
                        &nbsp;to
                            <uc4:CtlCalendarPickUp ID="CtlCalendarPickUpBusinessDateTo" runat="server" />
                        </td>
                    </tr>
                    <tr>
                        <td>
